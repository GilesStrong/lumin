...
class HEPAugFoldYielder(FoldYielder):
    def __init__(self, source_file:h5py.File, cont_feats:List[str], cat_feats:List[str], ignore_feats:Optional[List[str]]=None, targ_feats:Optional[List[str]]=None,
        ...
        super().__init__(source_file=source_file, cont_feats=cont_feats, cat_feats=cat_feats, ignore_feats=ignore_feats, input_pipe=input_pipe, output_pipe=output_pipe)
