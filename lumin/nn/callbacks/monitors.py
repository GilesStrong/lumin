...
class MetricLogger():
    ...
    def __init__(self, loss_names:List[str], n_folds:int, display:bool=IN_NOTEBOOK, autolog_scale:bool=True, extra_detail:bool=True, plot_settings:PlotSettings=PlotSettings()):
