...
def fold_train_ensemble(fold_yielder:FoldYielder, n_models:int, train_params:Dict[str,int], model_builder:ModelBuilder,
    ...
    nb = len(fold_yielder.source['fold_0/targets'])//train_params['bs']
