...
def check_rfpimp():
    assert pkg_resources.get_distribution("rfpimp").version > '1.3.1', '''Use of this function requires rfpimp>1.3.1, which is not currently available from pypi. Please install from source via:\n 
