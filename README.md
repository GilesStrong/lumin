...
- Inclusion of recent deep learning techniques and practices, including:
    ...
    - State-of-the-art optimisers, e.g. RAdam ((Liu et al.)[https://arxiv.org/abs/1908.03265v1]), LookAhead ([Zhang et al., 2019](https://arxiv.org/abs/1907.08610)) (as [Ranger](https://github.com/lessw2020/Ranger-Deep-Learning-Optimizer)): 
